...
+ Your entire repository will be checked using [Betty](https://github.com/alx-tools/Betty)
...
Check if you code fits the [ALX School coding style](https://github.com/alx-tools/Betty/wiki).
Check if your code is well documented and respect the [ALX School documentation format](https://github.com/alx-tools/Betty/blob/master/kernel-doc.pl)
You can check all of this by yourself, just follow the instructions on this [repository](https://github.com/alx-tools/Betty)
